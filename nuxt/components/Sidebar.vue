        ...
        <div class="p-10">
            ...
            <nav class="mb-6">
                <ul class="inline-flex flex-wrap">
                    <li class="m-1">
                        <a class="badge" href="https://github.com/r-freeman" title="GitHub">
                    ...
                    <li class="m-1">
                        <a class="badge" href="mailto:hello@ryanfreeman.dev" title="Mail">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path
                    ...
                    <li class="m-1">
                        <a class="badge" href="/rss.xml" title="RSS">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path
